      ...
      <Stack.Navigator initialRouteName={!authToken ? 'Login' : showWelcome ? 'Welcome' : 'Home'}>
        {!authToken && (
          <>
            ...
            <Stack.Screen name="Signup" component={SignupScreen} options={{ title: i18n.t('sign') }} />
            <Stack.Screen name="ForgotPassword" component={ForgotPasswordScreen} options={{ title: i18n.t('resetPassword') }} />
          </>
        )}

        <Stack.Screen name="Welcome" component={WelcomeScreen} options={{ headerShown: false }} />
        <Stack.Screen name="Home" component={HomeScreen} options={{ title: i18n.t('tarotStation') }} />
        <Stack.Screen name="Horoscope" component={HoroscopeScreen} options={{ title: i18n.t('horoscope') }} />
        <Stack.Screen name="Chat" component={ChatScreen} options={{ title: i18n.t('chat') }} />
        <Stack.Screen name="Settings" component={SettingsScreen} options={{ title: i18n.t('settings') }} />
        <Stack.Screen name="EditProfile" component={EditProfileScreen} options={{ title: i18n.t('editProfile') }} />
        <Stack.Screen name="MyBot" component={MyBotScreen} options={{ title: i18n.t('myBot') }} />
        <Stack.Screen name="Recharge" component={RechargeScreen} options={{ title: i18n.t('recharge') }} />
        <Stack.Screen name="WalletHistory" component={WalletHistoryScreen} options={{ title: i18n.t('walletHistoryScreen') }} />
        <Stack.Screen name="ZodiacSelection" component={ZodiacSelectionScreen} options={{ title: i18n.t('zodiacSelection') }} />
        <Stack.Screen name="TarotGame" component={TarotGame} options={{ title: i18n.t('fortuneTeller') }} />
        <Stack.Screen name="DailyCheckIn" component={DailyCheckInScreen} options={{ title: i18n.t('dailyCheckIn') }} />
        <Stack.Screen name="History" component={HistoryScreen} options={{ title: i18n.t('chatHistory') }} />
        <Stack.Screen name="SessionView" component={SessionView} options={{ title: i18n.t('chatHistoryView') }} />
        <Stack.Screen name="PrivacyPolicy" component={PrivacyPolicyScreen} options={{ title: i18n.t('privacyPolicy') }} />
