...
export default function HomeScreen({ navigation }) {
  ...
  const zodiacIconName = zodiacIcons[zodiacSign] || null;
    ...
    >
      ...
      <View style={styles.headerContainer}>
        <View style={styles.leftHeader}>
          <Text style={[styles.headerText, { color: isDark ? "#f8e1c1" : "#2c2c4e" }]}>
        ...
        >
          <Ionicons name="gift-outline" size={26} color={isDark ? "#f8e1c1" : "#2c2c4e"} />
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => navigation.navigate("CoinsReward")}
          style={styles.coinButton}
        >
          <FontAwesome name="bitcoin" size={26} color={isDark ? "#f8e1c1" : "#2c2c4e"} />
        </TouchableOpacity>
      </View>
